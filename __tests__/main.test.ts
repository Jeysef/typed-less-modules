...
describe("main", () => {
  ...
  it("generates types for all .less files when the pattern is a directory", async () => {
  ...
  it("generates types for all .less files and ignores files that match the ignore pattern", async () => {
    const pattern = `${__dirname}/dummy-styles`;
