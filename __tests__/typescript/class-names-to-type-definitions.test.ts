...
describe("classNamesToTypeDefinitions (without Prettier)", () => {
    ...
    describe("named", () => {
        it("converts an array of class name strings to type definitions", async () => {
            ...
            expect(definition).toEqual(`export declare const myClass: string;${os.EOL}export declare const yourClass: string;${os.EOL}`);
        });
        ...
        it("prints a warning if a classname is a reserved keyword and does not include it in the type definitions", async () => {
            ...
            expect(definition).toEqual(`export declare const myClass: string;${os.EOL}`);
            expect(console.log).toHaveBeenCalledWith(expect.stringContaining("[SKIPPING] 'if' is a reserved keyword"));
        });
        ...
        it("prints a warning if a classname is invalid and does not include it in the type definitions", async () => {
            ...
            expect(definition).toEqual(`export declare const myClass: string;${os.EOL}`);
            expect(console.log).toHaveBeenCalledWith(expect.stringContaining("[SKIPPING] 'invalid-variable' contains dashes"));
        });
    });
